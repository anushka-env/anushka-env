"""
Anushka — self-hosted header banner SVG (no external service dependency)
Replaces capsule-render + readme-typing-svg with a locally generated,
always-reliable banner living inside the repo itself.
"""
import os
...
BG0, BG1, BG2 = "#0F172A", "#4C1D95", "#8B5CF6"
INK = "#FFFFFF"
SUB = "#C4B5FD"
...
TAGLINE_LINES = [
    ...
    "Building with Python + Java + SQL",
    "Developing Skills in GenAI + Agentic AI",
]
